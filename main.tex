                    ...
                    \centering
                        \begin{tikzpicture}
                            ...
                            \addplot[
                                ...
                                node [right] {Group 1};
                                \addlegendentry{$y = 95.623x -330.04$}
                            \end{axis}
                        \end{tikzpicture}
                    \caption{Caption TBD.}\label{fig:ellips2}
                \end{figure}
